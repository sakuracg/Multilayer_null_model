...
name_list = ['层间富人俱乐部系数不变', '层间富人俱乐部系数减小', '层间富人俱乐部系数增加']
cas_no_change = [0.05267, 0.05511, 0.05451]
calpu_down = [0, 0, 0]
cas_up = [0.9474, 0.9622, 0.9647]
