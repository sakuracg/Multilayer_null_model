# @Time : Created on 2021/7/27 11:32
# @File : ？.py 
# @Author : xiaozhi
import numpy as np
import matplotlib
...
def f1(first_partition, second_partition):
    ...
    Works on overlappingn-overlapping complete/partial coverage partitions.
...
# nf = NF1([[8, 14, 15, 18, 20, 22, 23, 26, 27, 29, 30, 32, 33], [0, 1, 2, 3, 7, 9, 11, 12, 13, 17, 19, 21], [4, 5, 6, 10, 16], [24, 25, 28, 31]],
#              [[8, 9, 14, 15, 18, 20, 22, 26, 29, 30, 32, 33], [0, 1, 2, 3, 7, 11, 12, 13, 17, 19, 21], [23, 24, 25, 27, 28, 31], [4, 5, 6, 10, 16]])
nf = NF1([[0, 1, 2, 4], [3, 5]], [[0, 3, 5], [1, 2, 4]])
results = nf.summary()
score=results['details']['F1 mean'][0]
std=results['details']['F1 std'][0]
print(score)