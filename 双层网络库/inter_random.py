...
G = inter_random_1k(G0,community_list_s,nswap=500, max_tries=100000)
nx.write_edgelist(G,'network/IEEE300_inter_1K_kp.txt',data=False)

Gi=ig.Graph.Read_Edgelist("network/IEEE300_inter_1K_kp.txt")
