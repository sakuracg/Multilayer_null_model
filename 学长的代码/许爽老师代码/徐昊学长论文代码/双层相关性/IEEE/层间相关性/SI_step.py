...
G_Baw_pdup,df_Baw_pdup = creatG(filename ='IaI_pdup.csv')
G_Baw_pddown,df_Baw_pddown = creatG(filename ='IaI_pddown.csv')
G_Baw_pdrandom,df_Baw_pdrandom = creatG(filename ='IaI_pdrandom.csv')
...
list_origin = [si(G_Baw,0.02,110,[i]) for i in nodes_Baw[0:100]]
list_pdup = [si(G_Baw_pdup,0.02,110,[i]) for i in nodes_Baw[0:100]]
list_pddown = [si(G_Baw_pddown,0.02,110,[i]) for i in nodes_Baw[0:100]]
list_pdrandom = [si(G_Baw_pdrandom,0.110,85,[i]) for i in nodes_Baw[0:100]]
