...
#df_Baw.to_csv('Baw_twoup.csv',index = False)
###
#df_BA_pdup = G2df(G_BA_pdup_interup)
#df_Baw_BApdup = mergedf(df_BA_pdup,df_ws)
#df_BA_pdup.to_csv('BA_pdup_interup.csv',index = False)
#df_Baw_BApdup.to_csv('Baw_pdup_interup.csv',index = False)
###
#df_BA_pddown = G2df(G_BA_pdup_interdown)                       
#df_Baw_BApddown = mergedf(df_BA_pddown,df_ws)
#df_BA_pddown.to_csv('BA_pdup_interdown.csv',index = False)
#df_Baw_BApddown.to_csv('Baw_pdup_interdown.csv',index = False)
#
#df_BA_pdrandom = G2df(G_BA_pdup_interrandom)
#df_Baw_BApdrandom = mergedf(df_BA_pdrandom,df_ws)
#df_BA_pdrandom.to_csv('BA_pdup_interrandom.csv',index = False)
#df_Baw_BApdrandom.to_csv('Baw_pdup_interrandom.csv',index = False)
...
#df_Baw = mergedf(df_BA,df_ws)
#df_Baw.to_csv('Baw_twodown.csv',index = False)
###
#df_BA_pdup = G2df(G_BA_pddown_interup)
#df_Baw_BApdup = mergedf(df_BA_pdup,df_ws)
#df_BA_pdup.to_csv('BA_pddwon_interup.csv',index = False)
#df_Baw_BApdup.to_csv('Baw_pddown_interup.csv',index = False)
###
#df_BA_pddown = G2df(G_BA_pddown_interdown)                       
#df_Baw_BApddown = mergedf(df_BA_pddown,df_ws)
#df_BA_pddown.to_csv('BA_pddwon_interdown.csv',index = False)
#df_Baw_BApddown.to_csv('Baw_pddown_interdown.csv',index = False)
#
#df_BA_pdrandom = G2df(G_BA_pddown_interrandom)
#df_Baw_BApdrandom = mergedf(df_BA_pdrandom,df_ws)
#df_BA_pdrandom.to_csv('BA_pddown_interrandom.csv',index = False)
#df_Baw_BApdrandom.to_csv('Baw_pddown_interrandom.csv',index = False)
