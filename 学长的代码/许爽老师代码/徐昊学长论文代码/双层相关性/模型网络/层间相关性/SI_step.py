...
G_Baw_pdup,df_Baw_pdup = creatG(filename ='Baw_pdup.csv')
G_Baw_pddown,df_Baw_pddown = creatG(filename ='Baw_pddown.csv')
G_Baw_pdrandom,df_Baw_pdrandom = creatG(filename ='Baw_pdrandom.csv')
...
list_origin = [si(G_Baw,0.02,65,[i]) for i in nodes_Baw[50:150]]
list_pdup = [si(G_Baw_pdup,0.02,65,[i]) for i in nodes_Baw[50:150]]
list_pddown = [si(G_Baw_pddown,0.02,65,[i]) for i in nodes_Baw[50:150]]
list_pdrandom = [si(G_Baw_pdrandom,0.02,65,[i]) for i in nodes_Baw[50:150]]
