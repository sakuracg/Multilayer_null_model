...
pl.plot(iList_Baw_BArichup, 'rd-',markersize = 5,label='call层内富人俱乐部系数增加双层网络')
pl.plot(iList_Baw_wsrichup, 'bo-',markersize = 5,label='sms层内富人俱乐部系数增加双层网络')
pl.plot(iList_Baw_BArichdown, 'ys-',markersize = 5,label='call层内富人俱乐部系数减小双层网络')
pl.plot(iList_Baw_wsrichdown, 'g*-',markersize = 5,label='sms层内富人俱乐部系数减小双层网络')
