...
def cengjian(G_call, G_sms, G_call_gai1):
...
G_BA_pdup = nr.replace_degree_in2(G_BA,G_ws,1000,2000000)
end_time = int(round(time.time() * 1000))
print(f"学长算法执行时间{end_time - start_time}")
# G_BA_pddown = nr.replace_degree_de2(G_BA,G_ws,1000,2000000)


# G_BA_pdrandom = nr.replace_degree_random(G_BA,G_ws,1000,2000000)
#
