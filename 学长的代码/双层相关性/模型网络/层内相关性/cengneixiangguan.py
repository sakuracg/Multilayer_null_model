...
#G_ws_pdup = unm.assort_mixing(G_ws,nswap=500000, max_tries=500000, connected=1)
...
#df_ws_pdup.to_csv('ws_pdup.csv',index = False)
#df_BA_pddown.to_csv('BA_pddown.csv',index = False)
#df_ws_pddown.to_csv('ws_pddown.csv',index = False)
