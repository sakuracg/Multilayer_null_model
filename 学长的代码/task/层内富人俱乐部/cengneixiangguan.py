...
G_ws = creat_G(df_ws)
#
G_BA_richup = unm.rich_club_create(G_BA,k = 7,nswap=2000000, max_tries=40000000, connected=1)
G_BA_richup = delown(G_BA_richup)
G_BA_richdown = unm.rich_club_break(G_BA,k=7,nswap=2000000, max_tries=40000000, connected=1)
G_BA_richdown = delown(G_BA_richdown)
G_ws_richup = unm.rich_club_create(G_ws,k = 6,nswap=2000000, max_tries=40000000, connected=1)
G_ws_richup = delown(G_ws_richup)
G_ws_richdown = unm.rich_club_break(G_ws,k = 6,nswap=2000000, max_tries=40000000, connected=1)
