...
G_Baw_richup,df_Baw_richup = creatG(filename = 'Baw_BArichup.csv')
G_Baw_richdown,df_Baw_richdown = creatG(filename = 'Baw_BArichdown.csv')
G_Baw_richrandom,df_Baw_richrandom = creatG(filename = 'Baw_BArichrandom.csv')
...
list_origin = [si(G_Baw,0.02,70,[i]) for i in nodes_Baw[50:150]]
list_richup = [si(G_Baw_richup,0.02,70,[i]) for i in nodes_Baw[50:150]]
list_richdown = [si(G_Baw_richdown,0.02,70,[i]) for i in nodes_Baw[50:150]]
list_richrandom = [si(G_Baw_richrandom,0.02,70,[i]) for i in nodes_Baw[50:150]]
