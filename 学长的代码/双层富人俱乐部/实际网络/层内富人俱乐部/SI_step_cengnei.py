...
G_Baw,df_Baw = creatG(filename ='cas.csv')

G_Baw_BArichup,df_Baw_BArichup = creatG(filename ='cas_callrichup.csv')
G_Baw_wsrichup,df_Baw_wsrichup = creatG(filename ='cas_callrichdown.csv')
G_Baw_BArichdown,df_Baw_BArichdown = creatG(filename ='cas_smsrichup.csv')
G_Baw_wsrichdown,df_Baw_wsrichdown = creatG(filename ='cas_smsrichdown.csv')
...
list_BArichup = [si(G_Baw_BArichup,0.1,150,[i]) for i in nodes_Baw[50:150]]
list_wsrichup = [si(G_Baw_wsrichup,0.1,150,[i]) for i in nodes_Baw[50:150]]
list_BArichdown = [si(G_Baw_BArichdown,0.1,150,[i]) for i in nodes_Baw[50:150]]
list_wsrichdown = [si(G_Baw_wsrichdown,0.1,150,[i]) for i in nodes_Baw[50:150]]
...
pl.plot(iList_Baw_BArichup, 'rd-',markersize = 5,label='电话层内富人俱乐部系数增加双层网络')
pl.plot(iList_Baw_wsrichup, 'bo-',markersize = 5,label='短信层内富人俱乐部系数增加双层网络')
pl.plot(iList_Baw_BArichdown, 'ys-',markersize = 5,label='电话层内富人俱乐部系数减小双层网络')
pl.plot(iList_Baw_wsrichdown, 'g*-',markersize = 5,label='短信层内富人俱乐部系数减小双层网络')
pl.legend(loc="best",fontsize=10)
pl.xlabel('step',fontsize=10)
pl.ylabel('I(t)',fontsize=10)
plt.xticks(fontsize=10)
plt.yticks(fontsize=10)
plt.savefig('SI_rich1.png',dpi = 750)
